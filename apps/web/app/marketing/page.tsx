    ...
    <div className="min-h-screen bg-slate-950 text-slate-50 overflow-x-hidden">
      ...
      <header className="sticky top-0 z-50 w-full border-b border-slate-900 bg-slate-950/80 backdrop-blur-md">
        <div className="mx-auto flex max-w-7xl h-16 items-center justify-between px-6">
          ...
          <nav className="hidden md:flex items-center gap-8 text-sm font-medium text-slate-400">
            ...
            <a href="https://github.com/kp183/agentlens" target="_blank" rel="noreferrer" className="flex items-center gap-1 hover:text-white transition-colors">
      ...
      <section className="relative z-10 mx-auto max-w-7xl px-6 pt-20 pb-24 text-center md:pt-32 md:pb-36">
        ...
        <div className="mt-10 flex flex-wrap justify-center gap-4">
          ...
          <a 
            href="https://github.com/kp183/agentlens" 
            target="_blank"
            rel="noreferrer"
      ...
      <footer className="relative z-10 border-t border-slate-900 bg-slate-950 py-12 text-center text-xs text-slate-500">
        <div className="mx-auto max-w-7xl px-6 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-6">
            <a href="https://github.com/kp183/agentlens" target="_blank" rel="noreferrer" className="hover:text-slate-350 transition-colors">GitHub</a>
            <span>·</span>
            <a href="https://github.com/kp183/agentlens/blob/main/LICENSE" target="_blank" rel="noreferrer" className="hover:text-slate-350 transition-colors">MIT License</a>
            <span>·</span>
